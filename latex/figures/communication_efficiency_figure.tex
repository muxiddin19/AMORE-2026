...
% Remove figure* wrapper - parent file provides it
% Use stealth (lowercase) for compatibility

% ============================================
% PART A: Architecture Comparison (Top Row)
% ============================================
\begin{tikzpicture}[
	...
	scale=0.54, transform shape
	]
	
	% === (a) Traditional Text-based MAS ===
